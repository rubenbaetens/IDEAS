...
equation
  ...
  connect(gaiHea.u, nOcc)
    annotation (Line(points={{-62,-40},{-70,-40},{-70,0},{-110,0},{-110,0}},
                                                             color={0,0,127}));
  for i in 1:max(Medium.nC,1) loop
    connect(gaiCO2[i].u, nOcc)
      annotation (Line(points={{-10,20},{-70,20},{-70,0},{-110,0}},
                                                  color={0,0,127}));
  end for;
  connect(gaiWat.u, nOcc)
    annotation (Line(points={{-10,60},{-70,60},{-70,0},{-110,0},{-110,0}},
                                                           color={0,0,127}));
  ...
  connect(gainCon.u, gaiHea.y)
    annotation (Line(points={{-10,-20},{-30,-20},{-30,-30},{-30,-40},{-37,-40},
          {-39,-40}},                                        color={0,0,127}));
